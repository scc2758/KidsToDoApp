...
public class MainActivity extends AppCompatActivity
    implements java.util.Observer, NavigationView.OnNavigationItemSelectedListener {
  ...
  public void onUserInteraction() {
    super
        .onUserInteraction();                                 //Whenever the user interacts with the screen, it resets the handler
    parentModeUtility.resetTimeout();
  }

  public void onParentModeChanged() {                              //When parent mode is changed
    if (parentModeUtility
        .isInParentMode()) {                               //Set the visibility and views accordingly
  ...
  public boolean onNavigationItemSelected(@NonNull MenuItem item) {
    ...
    switch (item.getItemId()) {
      ...
      case R.id.ConfirmPassword:
        if (parentModeUtility
            .isInParentMode()) {               //If the user is in parent mode, logs out and makes the appropriate changes
