...
public class SettingsFragment extends Fragment implements View.OnClickListener {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    @SuppressLint("UseSwitchCompatOrMaterialCode") final Switch darkModeSwitch =
        view.findViewById(R.id.dark_mode_switch);
  ...
  private void setuptConstraintLayout(View view) {
  ...
  private void changeDarkMode(CompoundButton buttonView) {
  ...
  private void checkPhoneNumber(String numberString) {
