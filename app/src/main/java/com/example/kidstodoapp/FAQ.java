...
public class FAQ extends Fragment implements View.OnClickListener {
  private TextView faqText1, faqText2, faqText3, faqText4, faqText5, faqText6, faqText7, faqText8,
      faqText9, faqText10;
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    createFaqText(R.id.faq_entry_1_text, view);
    createFaqText(R.id.faq_entry_2_text, view);
    createFaqText(R.id.faq_entry_3_text, view);
    createFaqText(R.id.faq_entry_4_text, view);
    createFaqText(R.id.faq_entry_5_text, view);
    createFaqText(R.id.faq_entry_6_text, view);
    createFaqText(R.id.faq_entry_7_text, view);
    createFaqText(R.id.faq_entry_8_text, view);
    createFaqText(R.id.faq_entry_9_text, view);
    createFaqText(R.id.faq_entry_10_text, view);

    return view;
  }

  private void createFaqText(int rid, View view) {
    faqText1 = view.findViewById(rid);
