...
public class ToDoListFragment extends Fragment
    implements java.util.Observer, ToDoAdapter.OnEntryListener {
  ...
  public void update(Observable observable, Object o) {
    if (observable instanceof DataModel) {
      ...
      if (parentModeUtility.isInParentMode()) {
        adapter.setVIEW_TYPE(ToDoAdapter.ITEM_TYPE_EDIT);
      }        //Had to add this because this listener was being called every time the fragment came back into view
      else {
